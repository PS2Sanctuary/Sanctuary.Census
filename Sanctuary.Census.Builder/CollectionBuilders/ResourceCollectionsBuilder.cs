    ...
    private async Task BuildResourceCollectionAsync(ICollectionsContext dbContext, CancellationToken ct)
    {
        ...
        foreach (Resource resource in _clientDataCache.Resources)
        {
            ...
            (
                ...
                resource.InitialValueMax.ToNullableUInt(),
                resource.UseInitialValueAsMax,
                resource.MaxValue.ToNullableUInt(),
                resource.ValueMarkerLo.ToNullableUInt(),
                resource.ValueMarkerMed.ToNullableUInt(),
                resource.ValueMarkerHi.ToNullableUInt(),
