    ...
    )
    {
        ...
        foreach (FireMode fireMode in _serverDataCache.WeaponDefinitions.FireModes)
        {
            ...
            (
                ...
                fireMode.CloakAfterFireDelayMs == 0 ? null : fireMode.CloakAfterFireDelayMs,
                ...
                fireMode.PelletFanAngle == 0 ? null : new decimal(fireMode.PelletFanAngle),
                ...
                fireMode.SprintAfterFireDelayMs == 0 ? null : fireMode.SprintAfterFireDelayMs,
