...
/// <param name="Regions">The map regions' capture status'.</param>
[Collection]
...
(
    ...
    ushort ZoneInstance,
    long Timestamp,
    ValueEqualityList<MapState.MapRegionCaptureData> Regions
) : IRealtimeCollection
{
    /// <summary>
    /// Represents data pertaining to the capture status of a map region.
    /// </summary>
    ...
    public record MapRegionCaptureData
    (
